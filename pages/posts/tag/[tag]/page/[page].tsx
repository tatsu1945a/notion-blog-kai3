...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  const uppperCaseCurrentTag = currentTag.charAt(0).toUpperCase() + currentTag.slice(1);
  
  const posts = await getPostByTagAndPage(
    uppperCaseCurrentTag, 
    parseInt(currentPage, 10)
  )  

  const numberOfPagesByTag = await getNumberOfPagesByTag(uppperCaseCurrentTag);
...
const BlogTagList = ({ numberOfPagesByTag, posts, currentTag, allTags }) => {
